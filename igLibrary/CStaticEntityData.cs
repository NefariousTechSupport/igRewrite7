namespace igLibrary
{
	public class CStaticEntityData : igObject
	{
		...
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x07, 0x18, 0x30, "_ignoreOcclusionBoxes", new object[]{ 3, 1 })]
		public bool _ignoreOcclusionBoxes;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x08, 0x18, 0x30, "_receiveDecals", new object[]{ 4, 1 })]
		public bool _receiveDecals;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x09, 0x18, 0x30, "_disableVisual", new object[]{ 5, 1 })]
		public bool _disableVisual;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x0A, 0x18, 0x30, "_disableCollision", new object[]{ 6, 1 })]
		public bool _disableCollision;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x0B, 0x18, 0x30, "_castsShadows", new object[]{ 7, 1 })]
		public bool _castsShadows;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x0C, 0x18, 0x30, "_enableNavMesh", new object[]{ 8, 1 })]
		public bool _enableNavMesh;
		[igField(typeof(igBitFieldMetaField<EMobileShadowState, igUnsignedIntMetaField>), 0x09, 0x0D, 0x18, 0x30, "_mobileShadowState", new object[]{ 9, 2 })]
		public EMobileShadowState _mobileShadowState;
		[igField(typeof(igBitFieldMetaField<bool, igUnsignedIntMetaField>), 0x09, 0x0E, 0x18, 0x30, "_includeInBake", new object[]{ 11, 1 })]
