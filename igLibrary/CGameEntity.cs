namespace igLibrary
{
	...
	{
		[igField(typeof(igUnsignedIntMetaField), 0x09, 0x00, 0x70, 0x98, "_gameEntityPersistentProperties")]
		public uint _gameEntityPersistentProperties;
		[igField(typeof(igBoolMetaField), 0x09, 0x01, 0x74, 0x9C, "_ignoreOcclusionBoxes")]
		public bool _ignoreOcclusionBoxes;
		[igField(typeof(igUnsignedIntMetaField), 0x09, 0x02, 0x78, 0xA0, "_gameEntityProperties")]
		public uint _gameEntityProperties;
		[igField(typeof(igFloatMetaField), 0x09, 0x03, 0x7C, 0xA4, "_lifetimeCache")]
		public float _lifetimeCache;
		//[igField(typeof(igObjectRefMetaField<CAttachModelList>), 0x09, 0x04, 0x80, 0xA8, "_attachModelList")]
		//public CAttachModelList _attachModelList;
		//[igField(typeof(igObjectRefMetaField<CScopedScheduledFunction>), 0x09, 0x05, 0x84, 0xB0, "_animationCompleted")]
		//public CScopedScheduledFunction _animationCompleted;
		//[igField(typeof(igObjectRefMetaField<igCallbackDelegate>), 0x09, 0x06, 0x88, 0xB8, "_onAnimationCompleteDelegate")]
		//public igCallbackDelegate _onAnimationCompleteDelegate;
		//[igField(typeof(igHandleMetaField<COverrideRenderMatrixComponent>), 0x09, 0x07, 0x8C, 0xC0, "_overrideRenderMatrixComponent")]
		//public COverrideRenderMatrixComponent _overrideRenderMatrixComponent;
		[igField(typeof(igFloatMetaField), 0x09, 0x08, 0x90, 0xC8, "_fadeStartTime")]
		public float _fadeStartTime;
		[igField(typeof(igFloatMetaField), 0x09, 0x09, 0x94, 0xCC, "_fadeEndTime")]
		public float _fadeEndTime;
		[igField(typeof(igObjectRefMetaField<igObject>), 0x09, 0x0A, 0x98, 0xD0, "mModel")]	//CModelInstance
		public igObject mModel;
		[igField(typeof(igBoolMetaField), 0x09, 0x0B, 0x9C, 0xD8, "mBelowKillZ")]
		public bool mBelowKillZ;
		[igField(typeof(igBoolMetaField), 0x09, 0x0C, 0x9D, 0xD9, "_IsValidModel")]
		public bool _IsValidModel;
		//[igField(typeof(igObjectRefMetaField<CFxMaterialRedirectTable>), 0x09, 0x0D, 0xA0, 0xE0, "_dynamicModelMaterialOverrides")]
		//public CFxMaterialRedirectTable _dynamicModelMaterialOverrides;
		//[igField(typeof(igHandleMetaField<igVfxSpawnedEffect>), 0x09, 0x0E, 0xA4, 0xE8, "_spawnedRenderVfx")]
		//public igVfxSpawnedEffect _spawnedRenderVfx;
		//[igField(typeof(igObjectRefMetaField<CCloudBundle>), 0x09, 0x0F, 0xA8, 0xF0, "_cloudBundle")]
		//public CCloudBundle _cloudBundle;
		//[igField(typeof(igTimeMetaField), 0x09, 0x10, 0xAC, 0xF8, "_lastNetUpdateTime")]
